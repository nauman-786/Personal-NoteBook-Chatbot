...
st.set_page_config(page_title="LangGraph Tool Chat", page_icon="🛠️", layout="centered")
...
for thread_id in st.session_state["chat_threads"][::-1]:
    if st.sidebar.button(str(thread_id), key=f"tool-thread-{thread_id}"):
        st.session_state["thread_id"] = thread_id
